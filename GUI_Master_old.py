...
lbl = tk.Label(root, text="Brain Tumor Detection and Classification ", font=('Comic Sans MS', 28,' bold '), height=1,bg="black",fg="white")
...
def update_label(str_T):
    #clear_img()
    result_label = tk.Label(root, text=str_T, width=40, font=("bold", 20),bg='black', fg='white')
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D://brain tumor//brain tumor', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
button1 = tk.Button(text=" SELECT ", command=openimage,width=15, height=1, font=('Comic Sans MS', 15, ' bold '),bg="black",fg="white")
button1.place(x=10, y=150)

button2 = tk.Button( text="PRE-PROCESS", command=convert_grey, width=15, height=1, font=('Comic Sans MS', 15, ' bold '),bg="black",fg="white")
...
#
button4 = tk.Button( text="PREDICTION", command=test_model,width=15, height=1,bg="black",fg="white", font=('Comic Sans MS', 15, ' bold '))
...
exit = tk.Button( text="EXIT", command=window, width=15, height=1, font=('Comic Sans MS', 15, ' bold '),bg="black",fg="white")
