...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '),bg="#DA70D6")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=250, y=100)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=65,bg="#C21E56",fg="black")
lbl.place(x=0, y=0)
...
btn = tk.Button(frame, text="Register", bg="#C21E56",font=("",20),fg="white", width=9, height=1, command=insert)
